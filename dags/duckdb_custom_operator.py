...
# minha connection ID da MotherDuck connection
CONNECTION_DUCKDB = "my_motherduck_conn"
# minha connection ID do PostgreSQL connection
CONNECTION_POSTGRESDB = "my_postgresdb_conn"
